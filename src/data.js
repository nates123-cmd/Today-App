// Mock data for development. Surfaces wire to real Supabase reads
// (mantras, course_*, tide_oura_daily, habits) per spec §11 as they're built.
...
export const PILLARS = [
  {
    ...
    projects: [
      ...
      {
        id: 'p-accenture',
        name: 'Accenture review',
        meta: 'today 3pm',
        tasks: [{ id: 't5', label: 'Read pre-read', est: '30m' }],
      },
    ],
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        name: 'Pizza setup',
        meta: 'home',
        tasks: [{ id: 't8', label: 'Season the steel before weekend', est: '20m' }],
      },
      {
        id: 'p-fitness',
        name: 'Fitness',
        meta: 'daily',
        tasks: [{ id: 't9', label: 'Zone 2 — 45 min after work', est: '45m' }],
      },
    ],
  },
  {
