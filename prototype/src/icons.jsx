// icons.jsx — Minimal, line-based icon set tuned to the warm-dark palette.
...
const IconCheck = (p) => <Icon {...p} d={<path d="M5 12l4 4 10-10"/>} />;
...
const IconArrowU = (p) => <Icon {...p} d={<><path d="M12 19V5"/><path d="M6 11l6-6 6 6"/></>} />;
...
// Morning grounding tile icons — abstract glyphs
const IconBreath = (p) => (
  <Icon {...p} w={22} sw={1.2} d={<>
...
const IconPlay  = (p) => <Icon {...p} d={<path d="M7 4v16l13-8L7 4z"/>} />;
const IconPause = (p) => <Icon {...p} d={<><path d="M7 4v16"/><path d="M17 4v16"/></>} />;
const IconBolt  = (p) => <Icon {...p} d={<path d="M13 2L4 14h7l-1 8 9-12h-7l1-8z"/>} />;

Object.assign(window, {
  IconCheck, IconClose, IconChev, IconArrowR, IconArrowU,
  IconRegen, IconPlay, IconPause, IconBolt,
  groundingIcons,
});
