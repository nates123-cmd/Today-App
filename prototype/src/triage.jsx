// triage.jsx — Page two. The morning ritual.
...
function Triage({ initialProgress = 'mid', onPushNext, onRemainingMinsChange }) {
  const { PILLARS, CAL_EVENTS } = window.TODAY_DATA;
